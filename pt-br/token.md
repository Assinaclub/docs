...
_POST_ https://api.ipag.com.br/service/resources/card_tokens
...
### Estrutura do conteúdo do envio (JSON)

#### Cartão de Crédito

| Atributo | Tipo | Descrição | Tamanho |
| -------- | ---- | --------- | ------- |
| _card_   | Object | Dados do cartão | - |
...
| Atributo | Tipo | Descrição | Tamanho |
| -------- | ---- | --------- | ------- |
| _holder _ | _Object_ | Dados do Titular do Cartão de Crédito | - |
...
_GET_ https://api.ipag.com.br/service/resources/card_tokens?token=<token>